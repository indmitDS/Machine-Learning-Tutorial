...
> A curated list of resources for practicing data science using Python, including not only libraries, but also links to tutorials, code snippets, blog posts and talks. Collected from Github.

##### Books

[Introduction to Statistical Learning](https://web.stanford.edu/~hastie/ISLRv2_website.pdf) - The most authentic book on Learning Theory.
...
[The Hundred Page Machine learning Book](http://ema.cri-info.cm/wp-content/uploads/2019/07/2019BurkovTheHundred-pageMachineLearning.pdf) - Quick Glance into ML perspective.
[Introduction to ML with Python - Guid](https://files.isec.pt/DOCUMENTOS/SERVICOS/BIBLIO/INFORMA%C3%87%C3%95ES%20ADICIONAIS/Introction-to-machine_Muller.pdf) - Reference.
[Applied Machine Learning](https://link.springer.com/book/10.1007/978-3-030-18114-7) - Applied Perspective & Theory.
[Algorithms to Know for ML](https://github.com/PacktPublishing/40-Algorithms-Every-Programmer-Should-Know) - Quick tour into Algorithms. 
[Transact SQL Book](http://justpain.com/eBooks/Databases/SQL/Transact-SQL/The%20Guru's%20Guide%20To%20Transact-SQL.pdf)- SQL to know of. 
